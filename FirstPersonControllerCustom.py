...
class FirstPersonControllerCustom(Entity):
 ...
 #       self.camera_pivot.rotation_x -= mouse.velocity[1] * self.mouse_sensitivity[0]
  #      self.camera_pivot.rotation_x= clamp(self.camera_pivot.rotation_x, -90, 90)
        ...
        self.direction = Vec3(
            ...
            + self.right * (held_keys['keyboard.k_left'] - held_keys['keyboard.k_right'])).normalized()
        '''
        Original code, changed to remove movement left and right
        self.forward * (held_keys['w'] - held_keys['s'])
